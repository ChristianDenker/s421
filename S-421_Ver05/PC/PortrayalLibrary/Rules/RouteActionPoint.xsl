...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <!-- Surface: AreaFillGroup  : 
	 ...
	 4: symbol
	 5: hatch-->
	<xsl:param  name="s421AreaFillGroupSelect">3</xsl:param> 
   ...
   <xsl:template match="RouteActionPoint[@primitive='Surface']" priority="1">
      <areaInstruction>
         ...
         <drawingPriority>12</drawingPriority>
         <xsl:choose>
			<xsl:when test="$s421AreaFillGroupSelect = 1"> <!-- 1: color -->
				 <colorFill>
					 <color transparency="0.5">#AA44A8</color>
				 </colorFill>
            </xsl:when>	
            <xsl:when test="$s421AreaFillGroupSelect = 2"> <!-- 2: areaFillReference -->
				 <areaFillReference reference="RTEACTPOT01"/>
            </xsl:when>	
            <xsl:when test="$s421AreaFillGroupSelect = 3"> <!-- 3: pixmap -->
				<pixmapFill>
            ...
            <xsl:when test="$s421AreaFillGroupSelect = 4"> <!-- 4: symbol -->
            ...
            <xsl:when test="$s421AreaFillGroupSelect = 5"> <!-- 5: hatch -->
				 <hatchFill>
					 <areaCRS>Global</areaCRS>
					 <hatch>
						 <lineStyle capStyle="Round" joinStyle="Round" offset="0.01">
