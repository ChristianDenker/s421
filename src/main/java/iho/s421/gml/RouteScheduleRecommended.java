...
/**
 * <p>Java-Klasse für RouteScheduleRecommended complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="RouteScheduleRecommended">
 *   &lt;complexContent>
 ...
 *         &lt;element name="routeScheduleRecommendedExtensions" type="{http://www.iho.int/S421/gml/1.0}RouteExtensions" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RouteScheduleRecommended", propOrder = {
    "routeScheduleCollection",
    "routeScheduleElement",
    "routeScheduleRecommendedExtensions"
})
public class RouteScheduleRecommended
    extends InformationTypeType
{
    ...
    protected List<RouteExtensions> routeScheduleRecommendedExtensions;
    ...
    /**
     * Gets the value of the routeScheduleRecommendedExtensions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the routeScheduleRecommendedExtensions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRouteScheduleRecommendedExtensions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RouteExtensions> getRouteScheduleRecommendedExtensions() {
        if (routeScheduleRecommendedExtensions == null) {
            routeScheduleRecommendedExtensions = new ArrayList<RouteExtensions>();
        }
        return this.routeScheduleRecommendedExtensions;
    }
