...
/**
 * <p>Java-Klasse für RouteScheduleManual complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="RouteScheduleManual">
 *   &lt;complexContent>
 ...
 *         &lt;element name="routeScheduleManualExtensions" type="{http://www.iho.int/S421/gml/1.0}RouteExtensions" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RouteScheduleManual", propOrder = {
    "routeScheduleCollection",
    "routeScheduleElement",
    "routeScheduleManualExtensions"
})
public class RouteScheduleManual
    extends InformationTypeType
{
    ...
    protected List<RouteExtensions> routeScheduleManualExtensions;
    ...
    /**
     * Gets the value of the routeScheduleManualExtensions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the routeScheduleManualExtensions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRouteScheduleManualExtensions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RouteExtensions> getRouteScheduleManualExtensions() {
        if (routeScheduleManualExtensions == null) {
            routeScheduleManualExtensions = new ArrayList<RouteExtensions>();
        }
        return this.routeScheduleManualExtensions;
    }
